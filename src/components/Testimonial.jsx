  ...
  const testimonials = [
    {
      ...
      name: "Modin Shaikh",
      role: "Travel Agent",
      content: `Working with Hemanth was smooth from the very beginning. He delivered a complete full-stack solution ahead of schedule and maintained clear communication throughout the project. It’s rare to find a developer who understands both the technical aspects and the business needs so effectively.`,
      rating: 5,
      image: "/testimonials/modin.png"
    },
    {
      id: 2,
      name: "Hasan Tigrolli",
      role: "Hotel resort manager",
      content: `I've come across many developer portfolios, and his work is clean, modern, and well organized. The animations enhance the experience while keeping the performance smooth.`,
      rating: 5,
    ...
    },
    {
      id: 3,
      name: "Prathvi",
      role: "Multiple Homestay and Resort owner",
      content: `From planning to deployment, Hemanth handled the full-stack development with confidence and attention to detail. The final product is fast, reliable, and well-designed. I would gladly collaborate with him again in the future.`,
      rating: 4,
      image: "/testimonials/prathvi.png"
    },
  ];
      ...
      <div className="container max-w-6xl mx-auto">
        ...
        >
          <motion.div className="text-center" variants={itemVariants}>
            ...
            >
              My Client's Opinions
            </motion.h2>
            <motion.p
              className="text-base sm:text-lg text-muted-foreground mt-3 sm:mt-4 max-w-2xl mx-auto"
              variants={itemVariants}
            >
              What MY Clients<span className="text-primary font-semibold"> Rate </span>My Work.
            </motion.p>
          </motion.div>
