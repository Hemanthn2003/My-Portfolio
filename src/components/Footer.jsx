...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/hemanth-n-71b857253/", label: "LinkedIn" },
    { icon: <Instagram size={18} />, href: "https://www.instagram.com/_hemanth_n__?igsh=MXR1ajhuZWY1bHc2bQ%3D%3D&utm_source=qr", label: "Instagram" },
    { icon: <Github size={18} />, href: "https://github.com/Hemanthn2003", label: "GitHub" },
  ];
  ...
  const contactInfo = [
    { icon: <Mail size={16} />, text: "hemanthn270@gmail.com", href: "mailto:hemanthn270@gmail.com" },
    { icon: <Phone size={16} />, text: "+91 9481420976", href: "tel:+919481420976" },
  ];
  ...
  return (
    <footer className="relative  px-6 py-12 mt-20">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">HEMANTH N</h3>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                MERN-Stack developper creating the wonderful projects.
              </p>
            ...
            <motion.div variants={itemVariants}>
              <h4 className="text-gray-900 dark:text-white font-medium mb-4 text-sm uppercase tracking-wider">Explore</h4>
            ...
            {/* Contact */}
            <motion.div variants={itemVariants}>
              <h4 className="text-gray-900 dark:text-white font-medium mb-4 text-sm uppercase tracking-wider">Contact me</h4>
              <ul className="space-y-3">
            ...
            {/* Newsletter */}
            <motion.div variants={itemVariants} className="space-y-4">
              <h4 className="text-gray-900 dark:text-white font-medium text-sm uppercase tracking-wider">Follow for updates</h4>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                Follow up and get updates of my latest work.
              </p>
              <form
                action="mailto:hemanthn270@gmail.com"
                method="POST" 
                className="space-y-3">
                <input 
                  type="email" 
          ...
          >
            <div>
              <p>© {currentYear} All rights reserved@Hemanth N</p>
                <p>Design inspired by MD Sahil</p>
            </div>
