...
export const AboutSection = () => {
  ...
  const achievements = [
    { number: "10+", label: "Projects", icon: <Briefcase className="h-5 w-5" />, suffix: "" },
    { number: "3", label: "Years of experience in Freelancing", icon: <Calendar className="h-5 w-5" />, suffix: "+" },
    { number: "100", label: "Success", icon: <Target className="h-5 w-5" />, suffix: "%" },
    { number: "5", label: "Clients", icon: <User className="h-5 w-5" />, suffix: "+" }
  ];

  const techStack = [
    { category: "Frontend", items: ["React", "CSS3", "TypeScript", "JavaScript", "HTML", "Tailwind"] },
    { category: "Backend", items: ["Node.js", "Express"] },
    { category: "Cloud", items: ["AWS", "MongoDB"] }
  ];

  const features = ["MERN-stack expertise", "Clean, maintainable code", "Optmised performance", "Easy methodology", "24/7 support available", "Delivery at promised time"];

  const socialLinks = [
    { icon: <Github className="h-5 w-5" />, href: "https://github.com/Hemanthn2003" },
    { icon: <Linkedin className="h-5 w-5" />, href: "https://www.linkedin.com/in/hemanth-n-71b857253/" },
    { icon: <Mail className="h-5 w-5" />, href: "mailto:hemanthn270@gmail.com" }
  ];

  const tabContent = {
    personal: "Passionate about developing digital solutions that make an impact. When I'm not coding, I focus on digital marketing and content creation",
    professional: "With more than a year of experience in MERN stack development, I have delivered 10+ projects using modern technologies, specializing in scalable application architecture and performance optimization.",
    approach: "I focus on writing clean, maintainable code, performing thorough testing, and creating user-centered designs. My development process highlights collaboration, agile practices, and continuous improvement."
  };
  ...
  const handleDownload = () => {
    ...
    link.href = '/Hemanth-resume.pdf'; // Must be in public folder
      ...
      <div className="container mx-auto max-w-7xl relative">
        ...
        <div className="text-center mb-16 md:mb-20 px-2 sm:px-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold mb-4 sm:mb-6">
            ...
            <span className="block text-primary animate-pulse">Ideas and plans to life</span>
          </h1>
          <p className="text-base sm:text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Developing digital experiences that <span className="text-primary font-semibold"> balance</span>, <span className="text-primary font-semibold">innovation,</span> performance, and <span className="text-primary font-semibold">elegance</span>
          </p>
        </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-2xl overflow-hidden border-4 border-primary/20 shadow-2xl transition-all duration-500 group-hover:border-primary/40 group-hover:scale-105 md:group-hover:scale-110 relative">
                      <img src="/projects/hemanth.png" alt="HEMANTH N" className="w-full h-full object-cover" />
                  ...
                  <div className="flex-1 text-center md:text-left">
                    <h2 className="text-2xl sm:text-3xl font-bold mb-1 sm:mb-2">HEMANTH N</h2>
