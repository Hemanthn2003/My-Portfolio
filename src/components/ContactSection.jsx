  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Please try again or email me directly at hemanthn270@gmail.com",
        variant: "destructive"
      });
    } finally {
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto">
            Want me to build your project? or just want to say hi? My inbox is always open.
          </p>
        </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 hover:bg-accent/30 rounded-lg sm:rounded-xl transition-all duration-300">
                ...
                <div>
                  ...
                  <a
                    href="mailto:hemanthn270@gmail.com"
                ...
                {[
                  {
                    icon: Linkedin,
                    label: "LinkedIn",
                    url: "https://www.linkedin.com/in/hemanth-n-71b857253/",
                  },
                  {
                    icon: Github,
                    label: "GitHub",
                    url: "https://github.com/Hemanthn2003",
                  },
                  {
                    icon: Instagram,
                    label: "Instagram",
                    url: "https://www.instagram.com/_hemanth_n__?igsh=MXR1ajhuZWY1bHc2bQ%3D%3D&utm_source=qr",
                  },
                ].map((social, index) => (
                  <a
                    key={index}
            ...
            <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  placeholder="Hey, I'd love to work with  you..."
                />
              </div>
